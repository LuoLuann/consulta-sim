Feature: editar um médico
    As a médico
    I want to poder editar minhas informações
    So that atualizar dados pessoais e corrigir informações incorretas ou desatualizadas
...
# Cenário sem erro
  Scenario: editar especialidade de medico para especialidade valida
    ...
    Then eu recebo uma mensagem que avisa que o medico com crm 123789 foi atualizado
